...
class Dataset(Base):
    ...
    Data layout on disk:
      uploaded_datasets/user_<user_id>/dataset_<id>/
        ...
        ├── news.csv            — REQUIRED: news_id, text, label, title, url, ...
        ├── tweets.csv          — OPTIONAL: tweet_id, news_id, text, user_id, ...
        ├── retweets.csv        — OPTIONAL: tweet_id, user_id
        ├── replies.csv         — OPTIONAL: reply_id, tweet_id, parent_reply_id, text, user_id, ...
        ├── likes.csv           — OPTIONAL: tweet_id, user_id
        ├── users.csv           — OPTIONAL: user_id, screen_name, followers_count, ...
        └── evidence.csv        — OPTIONAL: news_id, url, content
    """
